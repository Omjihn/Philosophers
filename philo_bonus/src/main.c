...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/21 16:56:18 by gbricot           #+#    #+#             */
/*   Updated: 2023/06/21 18:13:19 by gbricot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char **av)
{
	...
	pthread_create(&vars->trd, NULL, &ft_philosopher, vars);
	sleep(1);
	int	i = 0;
	while (vars->pid[i])
	{
